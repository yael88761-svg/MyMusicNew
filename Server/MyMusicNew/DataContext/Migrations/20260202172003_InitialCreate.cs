        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSmartPlaylist = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EHoliday = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FeatureId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SongId = table.Column<int>(type: "int", nullable: false),
                    Tempo = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    Energy = table.Column<decimal>(type: "decimal(3,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AudioFeatures", x => x.FeatureId);
                    table.ForeignKey(
                        name: "FK_AudioFeatures_Songs_SongId",
                        column: x => x.SongId,
